...
if __name__ == "__main__":
    ...
    net = network.NoisyDQN(env.observation_space.shape, env.action_space.n).to(device)
    tgt_net = network.NoisyDQN(env.observation_space.shape, env.action_space.n).to(device)
