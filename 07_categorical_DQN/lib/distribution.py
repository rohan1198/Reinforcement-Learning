...
def projection_distribution(target_model, next_observation, reward, done, batch_size, vmin, vmax, atoms, gamma, device):
...
def calc_loss(eval_model, target_model, buffer, vmin, vmax, atoms, gamma, batch_size, device):
    ...
    proj_dist = projection_distribution(target_model, next_observation, reward, done, batch_size, vmin, vmax, atoms, gamma, device)
